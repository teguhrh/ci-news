    ...
    <a class="navbar-brand" href="absensi">Buku Absensi</a>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="<?php echo base_url('rekap/create') ?>" class="btn btn-md btn-success mb-3">TAMBAH DATA</a>
                        ...
                        <tbody>
                            <?php foreach ($rekapData as $data) : ?>
                                ...
                                <td><?= $data['no']; ?></td>
                                    ...
                                    <td>
                                        <a href="/rekap/edit/<?= $data['no']; ?>" class="btn btn-primary">Edit</a>
                                        <a href="/absensi/delete/<?= $data['no']; ?>" class="btn btn-danger" onclick="return confirmDelete();">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
