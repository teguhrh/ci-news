                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($data['foto'])) : ?>
                                    <a href="<?= $data['foto'] ?>" download class="btn btn-sm btn-secondary">Download</a>
                                    
                                <?php endif; ?>
                                
                            <?php if (!empty($data['foto'])) : ?>
                                <a href="<?= base_url('formulirrr/download/' . $data['id']) ?>" class="btn btn-sm btn-secondary">Download</a>
                    <?php endif; ?>
                            </td>
                            <td>
