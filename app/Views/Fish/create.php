    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo base_url('fish/store') ?>" method="POST">
                        <?= csrf_field() ?>
                            <div class="form-group">
                                <label>LEARN</label>
                                <input type="text" class="form-control" name="learn" rows= "4" placeholder="Masukkan Title">
                            </div>
                            <div class="form-group">
                                <label>WORRY</label>
                            ...
                            <div class="form-group">
                                <label>SOCIAL</label>
                               <textarea class="form-control" name="social" rows="4" placeholder="Masukkan Konten"></textarea>
                            </div>
